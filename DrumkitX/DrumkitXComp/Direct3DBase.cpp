...
/**
 * @class Direct3DBase
 * @brief Helper class that initializes DirectX APIs for 3D rendering.
 */
...
void Direct3DBase::CreateDeviceResources()
{
	...
	DrumkitXComp::ThrowIfFailed(device.As(&m_d3dDevice));
	DrumkitXComp::ThrowIfFailed(context.As(&m_d3dContext));
}
