...
using namespace DrumkitXComp;

/**
 * @class Direct3DContentProvider
 * @brief Implements IDrawingSurfaceContentProvider interface to be 
 *        used as a content provider for the DrawingSurface control.
 */
